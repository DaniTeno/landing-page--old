export function mobileHomeLogic(){
     const d = document,
          ...
          $about = d.querySelector('.mobile-personal-info'),
          $text = $home.querySelector('#mobile-text'),
          $js = $home.querySelector('#js img'),
          $css = $home.querySelector('#css img'),
          $html = $home.querySelector('#html img');

     d.querySelector('.principal-band').style.background = 'linear-gradient(to bottom, rgb(15, 0, 80), rgb(57, 0, 80))';
     
     $home.appendChild($clock);
     $clock.classList.add('mobile-clock') 
     if(localStorage.getItem('lang').includes('es'))$text.textContent = pageInfoEs;
     ...
     d.addEventListener('scroll', e =>{       
          const dElement = document.documentElement,
               scrollTopPercentage = dElement.scrollTop*100/dElement.scrollHeight,
               scrollBottomPercentage = (dElement.scrollTop+dElement.clientHeight)*100/dElement.scrollHeight,
               $gifBanner = $home.querySelector('.mobile-head-banner-gif'),
               $text = $home.querySelector('#mobile-text'),
               $techUsedSection = $home.querySelector('.mobile-tech-used'),
               ...
               $resume = $about.querySelector('#mobile-resume').classList,
          ...
          if(scrollTopPercentage < 6) {              
               ...
               $techUsedSection.classList.add('hidden')
               $techUsedSection.classList.remove('show')
          ...
          console.log(scrollTopPercentage,scrollBottomPercentage)
     });
