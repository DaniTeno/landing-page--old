...
export function mobileHome(){
     ...
     if(localStorage.getItem('lang').includes('es')){
          $home.innerHTML = `
               ...
               <img src="../../assets/mobile/home-bg.jpg" class="mobile-head-banner-gif">
               
               <p>Tecnologías</p>
               <div class="mobile-tech-used hidden">
                    <div class="mobile-tech-used-figures">
                    ...
                    <div id="mobile-text" class="hidden">
                    </div>
               </div>
               ...
               <div class="mobile-personal-info">
                    ...
                    <div>
                         ...
                         <div id="mobile-resume" class="hidden">
                              <p>Resumen</p>
